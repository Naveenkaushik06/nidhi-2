...
// const AdminLogin = ({ handleLogin }) => { // Receive handleLogin as a prop
...
//             <form onSubmit={handleLogin} className="text-start h-full w-full flex flex-col  place-items-center gap-5">
//                 {/* input email */}
