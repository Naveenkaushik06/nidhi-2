...
const Signup = () => {
  ...
  return (
    ...
    <p className='text-center p-3 text-4xl font-semibold tracking-wider opacity-80'>Register</p>
    ...
    <form className='text-start h-full w-full flex flex-col  place-items-center gap-5'>
                ...
                <label htmlFor="" className='font-sarif py-1'>First name</label>
                    <input type="text" placeholder='enter first name' className='w-full text-black px-4 py-2 text-base border border-gray-300 rounded outline-none focus:ring-blue-500 focus:border-blue-500 focus:ring-1 tracking-widest' />
                </div>
                    
                {/* 2nd Input */}
                <div className='w-full grid grid-cols-1'>
                <label htmlFor="" className='font-sarif 
                    py-1'>Last name</label>
                    <input type="text" placeholder='enter last name' className='w-full text-black px-4 py-2 text-base border border-gray-300 rounded outline-none focus:ring-blue-500 focus:border-blue-500 focus:ring-1 tracking-widest' />
                    </div>
                </div>
            {/* 3rd Input  */}
                <div className='flex flex-col w-4/5'>
                    <label htmlFor="" className='font-sarif 
                    py-1'>Enter email</label>
                    <input type="text" placeholder='enter Email' className='w-full text-black px-4 py-2 
            ...
            {/* 4th Input */}
                <div className='flex flex-col w-4/5'>
                    <label htmlFor="" className='font-sarif 
                    py-1'>Enter phone</label>
                    <input type="text" placeholder='enter phone' className='w-full text-black px-4 py-2 
                    text-base border border-gray-300 rounded 
                    outline-none focus:ring-blue-500 
                    focus:border-blue-500 focus:ring-1 
                    tracking-widest' />
                ...
                <div className="relative text-start w-4/5 flex flex-col">
                    ...
                    {/* Login button */}
                    <p className='text-start text-pretty w-fit'>if you have already account ? <Link to="/admin"><span 
                    className='font-semibold text-xl'>login account</span></Link></p>
