...
const Register = () => {
  ...
  return (
    <form className=' h-2/4 w-2/4 border text-white m-auto flex flex-col gap-10 rounded-xl px-5 py-6 place-items-center bg-gradient-to-r from-blue-900 to-indigo-300 shadow-xl'>
            ...
            <p className='text-center p-3 text-4xl font-semibold tracking-wider opacity-80'> Enter verification code </p>
            <label htmlFor="" className='font-sarif py-1'> check your register email and fill correct otp inside box </label>

            {/* OTP Input */}
          <div 
            className='flex flex-row text-center justify-center gap-5'>
